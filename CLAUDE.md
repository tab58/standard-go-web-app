...
`AGENTS.md` keeps the full map of specific files and docs worth reading — architecture references, per-service hard-rules files, test strategy, READMEs. Don't read it eagerly; consult its Reference Documentation section on demand when a task calls for something it covers.
